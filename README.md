...
│   ├── dashboard.html             # Main dashboard with 5-step process
│   ├── login.html                 # User authentication
│   └── reports.html               # Report management
├── 📁 reports/                    # Generated test reports (PDF/HTML)
├── 📁 uploads/                    # Uploaded test documents
├── 📁 database/                   # SQLite database
│   └── test_history.db            # Test history and user data
...
Final year engineering project focused on leveraging artificial intelligence and natural language processing to revolutionize software testing. Passionate about creating accessible, user-friendly solutions that bridge the gap between technical and non-technical users.
